...
export namespace structs {
	...
	export class VulnDashboard {
	    ...
	    static createFrom(source: any = {}) {
	        return new VulnDashboard(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.TotalTasks = source["TotalTasks"];
	        this.TotalVulnerabilities = source["TotalVulnerabilities"];
	        this.TotalFailed = source["TotalFailed"];
	        this.SeverityCritical = source["SeverityCritical"];
	        this.SeverityHigh = source["SeverityHigh"];
	        this.SeverityMedium = source["SeverityMedium"];
	        this.SeverityLow = source["SeverityLow"];
	        this.SeverityInfo = source["SeverityInfo"];
	        this.RecentTasks = this.convertValues(source["RecentTasks"], TaskResult);
	    }
