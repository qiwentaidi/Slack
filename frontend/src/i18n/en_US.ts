export default {
    ...
    titlebar: {
        ...
        'switchDesc': 'Set interface language to Chinese',
        'switchEn': 'Switch to English',
        'switchDescEn': 'Set interface language to English',
        'toggleTheme': 'Toggle Theme',
        'toggleThemeDesc': 'Switch between light and dark',
        'openConsole': 'Open Console',
        'openConsoleDesc': 'View runtime logs',
        'helperCommandHint': 'Type > to show commands',
    },
    home: {
        'riskTargets': 'Risk Targets Top 5',
        'totalRiskTargets': 'Total',
        'riskEmpty': 'No risk targets yet',
