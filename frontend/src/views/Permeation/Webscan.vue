...
class Engine {
    ...
    public async WebRunner() {
        ...
        let options: structs.WebscanOptions = {
            ...
            ActiveTimeout: global.webscan.active_timeout,
        }
        addActivity({
    ...
    <CustomTabs>
        <el-tabs type="border-card">
            <el-tab-pane label="信息">
                <el-table :data="fp.table.pageContent" stripe height="100vh" :highlight-current-row="true"
            ...
            <el-tab-pane label="漏洞">
                <el-table :data="vp.table.pageContent" stripe height="100vh" :highlight-current-row="true"
                    :cell-style="{ textAlign: 'center' }" :header-cell-style="{ 'text-align': 'center' }"
                    @sort-change="((data: any) => vp.ctrl.sortChange(data, true))"
                    @row-contextmenu="handleWebscanContextMenu" @filter-change="vp.ctrl.filterChange">
